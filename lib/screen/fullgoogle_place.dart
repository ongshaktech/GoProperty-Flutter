// // ignore_for_file: depend_on_referenced_packages, sized_box_for_whitespace, import_of_legacy_library_into_null_safe
...
//     this.hint = "Search for your location/society/apt",
...
//                 logo: widget.logo,
//                 resultTextStyle: TextStyle(color: notifire.getdarkscolor))),
//       );
//     } else {
...
//           ),
//           child: widget.logo ?? curentlocation(context),
//         );
//       } else {
...
//       }
//       children.add(widget.logo ?? curentlocation(context));
...
//             _defaultDecoration("Search for your location/society/apt"),
//       ),
//     );
//   }
...
//                 prediction: p, onTap: onTap, resultTextStyle: resultTextStyle),
//           )
//           .toList(),
//     );
//   }
...
//     String hint = "Search for your location/society/apt",
